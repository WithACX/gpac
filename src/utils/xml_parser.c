...
void xml_scte35_parse(GF_XMLNode *node, GF_BitStream *bs);
void xml_emeb_parse(GF_XMLNode *node, GF_BitStream *bs);
void xml_emib_parse(GF_XMLNode *node, GF_BitStream *bs);
